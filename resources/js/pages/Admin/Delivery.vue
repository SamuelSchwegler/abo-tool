<template>
    ...
    <PageContent>
        <div class="grid gap-4 grid-cols-3 pb-4" v-if="delivery.hasOwnProperty('id')">
            <Box title="Lieferdienst">
        ...
        <Box v-for="(product_items, product) in delivery.items"  v-if="delivery.hasOwnProperty('items')" :key="'delivery_items_' + deliveryItemsKey">
                <delivery-product-items :delivery-items="product_items" :overall="false"></delivery-product-items>
        </Box>
    </PageContent>
</template>
