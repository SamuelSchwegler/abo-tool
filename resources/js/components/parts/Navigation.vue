        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
                ...
                <PopoverGroup as="nav" class="hidden md:flex space-x-10" v-if="isLoggedIn">
                    ...
                    <router-link to="/dashboard" class="text-base font-medium text-gray-500 hover:text-gray-900"> Dashboard </router-link>
                ...
                <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0" v-if="isLoggedIn">
                    <a style="cursor: pointer;" @click="logout" class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700"> Logout </a>
                </div>
